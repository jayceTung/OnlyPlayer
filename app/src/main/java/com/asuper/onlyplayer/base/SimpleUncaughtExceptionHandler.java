...
public class SimpleUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    /** CrashHandler实例 */
    private static SimpleUncaughtExceptionHandler INSTANCE;
    /** 程序的Context对象 */
    ...
    public static SimpleUncaughtExceptionHandler getInstance() {
        if (INSTANCE == null)
            INSTANCE = new SimpleUncaughtExceptionHandler();
        return INSTANCE;
    }
